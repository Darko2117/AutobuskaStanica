 ...
 * @author danij
 */
public class UnosKarataForma extends javax.swing.JFrame {

    /**
     * Creates new form UnosKarata
     */
    public UnosKarataForma() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton3.setText("STAMPAJ RAČUN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnosKarataForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UnosKarataForma().setVisible(true);
            }
        });
    }
